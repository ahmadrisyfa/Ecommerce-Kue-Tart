    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Silahkan Edit Data Category</h5>
        
                      <form method="POST" action="{{ url('admin/category/'.$data->id.'/edit') }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                          <label for="inputText" class="col-sm-2 col-form-label">Nama</label>
                          <div class="col-sm-10">
                            <input  value="{{ old('nama', $data->nama)}}"   required name="nama" type="text" class="form-control">
                          </div>
                        </div>     
