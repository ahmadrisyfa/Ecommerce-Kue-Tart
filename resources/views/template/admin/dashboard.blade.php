...
<head>
  ...
  <link href="{{asset('website')}}/img/logo.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      @if ($data = \App\Models\NameWebsite::first())  
      @php
    $data = \App\Models\NameWebsite::first()->get();
  @endphp
   
  @foreach ($data as $value)      
      <a href="{{url('admin/dashboard')}}" class="logo d-flex align-items-center">
        <img src="{{ asset('storage/'. $value->gambar) }}" alt="">    
        <span class="d-none d-lg-block">{{$value->nama}}</span>          
      </a>
  ...
  <a href="{{url('admin/dashboard')}}" class="logo d-flex align-items-center">
    ...
    <span class="d-none d-lg-block">Website Contoh</span>          
  </a>
  <i class="bi bi-list toggle-sidebar-btn"></i>
  @endif
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          @else
          <li>
            <a  href="{{url('/login')}}" class="dropdown-item d-flex align-items-center" href="#">
...
<main id="main" class="main">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      ...
      @if ($data)
      @foreach ($data as $value)        
      <strong><span>{{$value->nama}}</span></strong>.
      @endforeach
        
      @else
      <strong><span>Website Contoh</span></strong>.    
      @endif
       All Rights Reserved
    </div>
    {{-- <div class="credits">
